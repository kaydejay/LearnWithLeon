//Arrays
//Your pokemon party order which is a list of pokemon has been leaked to Misty. Please create a function that 
//reverses your list and prints it to the console. 

function reverseList (partyList) {
    console.log(partyList.reverse())
}

reverseList (['Pikachu', 'Charmander', 'Bulbasaur'])
